...
export const ProfileCard: React.FC<ProfileCardProps> = ({ className = '', style }) => {
  ...
  const tabContent = {
    about: {
      title: "About Me",
      content: (
        <div className="text-gray-300 text-md leading-relaxed space-y-3">
          <p>
    ...
    experiences: {
      ...
      content: (
        <div className="text-gray-300 text-md leading-relaxed space-y-3">
          <div>
            <h3 className="text-white font-semibold mb-2">Salesforce (2021 - Present)</h3>
            <p>Sales Representative - 3 years of experience in enterprise sales and customer relationship management.</p>
          </div>
          <div>
            <h3 className="text-white font-semibold mb-2">Previous Experience</h3>
            <p>Worked in various sales roles before joining Salesforce, building expertise in B2B sales and client management.</p>
          </div>
        </div>
      )
    },
      ...
      content: (
        <div className="text-gray-300 text-md leading-relaxed space-y-3">
          <div>
            ...
            <p>• Schedule meetings during business hours (9 AM - 5 PM)</p>
            <p>• Send follow-up emails within 24 hours</p>
            <p>• Prepare demo materials in advance</p>
          </div>
        </div>
      )
    }
  ...
  return (
    <div className={`rounded-lg overflow-hidden relative ${className}`} style={{ backgroundColor: '#363C43', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.6), 4px 0 8px rgba(0, 0, 0, 0.6)', ...style }}>
      <div className="flex relative p-5 px-3 gap-3">
      ...
      <div className="p-6 h-full overflow-y-auto relative" style={{ maxHeight: 'calc(100% - 60px)' }}>
